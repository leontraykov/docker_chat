...
Допустим('зарегистрированы два пользователя') do
  @user1 = User.find_by(email: 'user1@example.com') || FactoryBot.create(:user, email: 'user1@example.com',
                                                                                password: 'password')
  @user2 = User.find_by(email: 'user2@example.com') || FactoryBot.create(:user, email: 'user2@example.com',
                                                                                password: 'password')
end
